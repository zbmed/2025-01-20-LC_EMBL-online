...
venue: "Library Carpentry Workshop - ONLINE"         # brief name of host site without address (e.g., "Euphoric State University")
...
humandate: "Jan 20-24, 2025"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
helper: ["Rabea Müller", "Till Sauerwein", "Vanessa Scharf"]   # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: ["victoria.yan@embl.de"]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
...
<div id="shell-setup"> {% comment %} Start of the 'shell' section. {% endcomment %}
  ...
  <p>
    Bash is a widely used shell that allows you to perform simple tasks more quickly. 
    Instructions for setup can be found in the <a href="https://librarycarpentry.org/lc-shell/index.html#setup">lesson</a>.
  </p>
</div>
...
<div id="python-setup">
  <h3>Python</h3>
  <p>
    Python is a popular language for research and is also suitable for general programming. 
    A guide is available in the <a href="https://librarycarpentry.org/lc-python-intro/index.html#installing-python-using-anaconda">lesson</a>.
  </p>
</div>
